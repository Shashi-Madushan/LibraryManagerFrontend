...
const GetLendingByBook = () => {
  ...
  const handleSearch = async () => {
    ...
    setSearched(true);
    try {
      const response = await getBookLendingHistory(bookName.trim());
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <h3 className="text-2xl font-bold mb-6 text-center">Get Lending History By Book</h3>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center p-8">
          ...
          <p className="text-xl text-gray-500">No lending history found for this book</p>
        </div>
      ) : lendings.length > 0 ? (
...
export default GetLendingByBook;
